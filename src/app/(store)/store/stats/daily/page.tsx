...
import { getDailySalesStats } from "@/actions/orders";
...
export default function DailyStatsPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold mb-6">일별 판매현황</h1>
        ...
        <Table>
          ...
          <TableBody>
            ...
            <TableRow className="font-bold border-t-2">
              ...
              <TableCell className="text-right">{stats.reduce((s, d) => s + d.count, 0)}건</TableCell>
              <TableCell className="text-right">{stats.reduce((s, d) => s + d.amount, 0).toLocaleString()}원</TableCell>
            </TableRow>
          </TableBody>
        </Table>
      ) : (
